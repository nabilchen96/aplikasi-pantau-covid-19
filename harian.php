...
<div class="row">
    ...
    <div class="card border-left-danger shadow h-100 py-2">
        ...
        <div class="row no-gutters align-items-center">
            <div class="col mr-2">
            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Penambahan Positif</div>
            <div class="h5 mb-0 font-weight-bold text-danger-800">
                <?php echo number_format($data['update']['penambahan']['jumlah_positif']); ?>
            </div>
            </div>
            <div class="col-auto">
            <i class="fas fa-head-side-cough fa-2x text-danger-300"></i>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="card border-left-danger shadow h-100 py-2">
        ...
        <div class="row no-gutters align-items-center">
            ...
            <div class="h5 mb-0 font-weight-bold text-danger-800">
                <?php echo number_format($data['update']['penambahan']['jumlah_meninggal']); ?>
            </div>
            </div>
            <div class="col-auto">
    ...
    <div class="card border-left-success shadow h-100 py-2">
        ...
        <div class="row no-gutters align-items-center">
            ...
            <div class="h5 mb-0 font-weight-bold text-success-800">
                <?php echo number_format($data['update']['penambahan']['jumlah_sembuh']); ?>
            </div>
            </div>
            <div class="col-auto">
    ...
    <div class="card border-left-warning shadow h-100 py-2">
        ...
        <div class="row no-gutters align-items-center">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800">
                <?php echo number_format($data['update']['penambahan']['jumlah_dirawat']); ?>
            </div>
            </div>
            <div class="col-auto">
